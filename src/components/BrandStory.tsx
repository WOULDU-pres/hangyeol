...
const themeConfig = {
  ...
  warm: {
    ...
    title: '온기가 전하는 이야기',
    story: {
      intro: '온화는 할머니의 품 같은 그 편안함에서 시작됐어요. 어떤 날이든 "괜찮다, 괜찮아"라고 말해주는 그런 포근함, 지친 하루의 끝에서 만나는 고마운 온기를 담고 싶었거든요.',
      middle: '지원님에게는 참 특별한 마법이 있어요.<br />함께 있으면 세상이 조금 더 안전해지는 느낌?<br />마치 따뜻한 차 한 잔을 건네받는 것처럼<br />마음 한구석이 스르르 녹아내리며 편안해지는 거죠.',
      closing: '온화는 그런 지원님의 온기를 고스란히 담아내려고 해요.<br />피부에 닿는 순간부터 마음까지 따뜻해지는, 진짜 포근함을 전해드리고 싶어요.',
      finalMessage: '어떤 날이든 괜찮아질 거예요.<br />온화와 함께라면 매일 안아주는 온기를 느낄 수 있을 테니까요.'
    }
  }
}
